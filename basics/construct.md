...
Также важно понимать, что разные конструкции вполне себе сочетаемы и могут вкладываться друг в друга (к примеру, в циклы можно помещать условия и наоборот). Также циклы могут работать не только от 1 до 5, но и от 5 до 1 (в обратном направлении), а размер шага не всегда должен быть единицей (так можно проскакивать четные/нечетные элементы). Применение таким фишкам будет показано в дальнейших материалах.
